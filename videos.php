    ...
    <div class="row g-5">
      <div class="col-md-12">
        ...
        <article class="blog-post" id="comunicados_principal">
          <h2 class="blog-post-title m-4 comunicados font-paco">Videos</h2>
          <hr>
        </article>
        ...
        <div class="col-lg-12 d-flex flex-wrap mb-4 ">
          ...
          <a href="orgullo-mexiquence.php" class="col-lg-3 card bg-none border-none px-3 text-center">
            <div class="card-img">
              <img src="img/orgullo.png" alt="">
            </div>
            <div class="card-body">
              <div class="card-title">
                <h5 class="font-paco">Orgullos Mexiquenses</h5>
              </div>
            </div>
          </a>


          <a href="pacontestarte.php" class="col-lg-3 card bg-none border-none px-3 text-center">
            <div class="card-img">
              <img src="img/pacontestarte.png" alt="">
            </div>
            <div class="card-body">
              <div class="card-title">
                <h5 class="font-paco">Pacontestarte</h5>
              </div>
            </div>
          </a>


          <a href="accion-paco.php" class="col-lg-3 card bg-none border-none px-3 text-center">
            <div class="card-img">
              <img src="img/en-accion.png" alt="">
            </div>
            <div class="card-body">
              <div class="card-title">
                <h5 class="font-paco">En acción con paco santos</h5>
              </div>
            </div>
          </a>
          ...
          <a href="tuvoz.php" class="col-lg-3 card bg-none border-none px-3 text-center">
            <div class="card-img">
              <img src="img/tu-voz.png" alt="">
            </div>
            <div class="card-body">
              <div class="card-title">
                <h5 class="font-paco">Tu voz en el congreso</h5>
              </div>
            </div>
          </a>
          ...
          <a href="videos-fideicomiso.php" class="col-lg-3 card bg-none border-none px-3 text-center">
            <div class="card-img">
              <img src="img/fideicomiso.png" alt="">
            </div>
            <div class="card-body">
              <div class="card-title">
                <h5 class="font-paco">Fideicomiso</h5>
              </div>
            </div>
          </a>
        </div>
