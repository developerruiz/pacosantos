    ...
    <div class="row g-5">
      <div class="col-md-8">
        ...
        <article class="blog-post">
          <h2 class="blog-post-title ">SOY PACO SANTOS</h2>
          <p class="blog-post-meta">23 de Julio de 1973</p>

          <p>Nació en el municipio de Cuautitlán México el 23 de Julio de 1973, estudió tres diplomados en
            Administración de Recursos Hidráulicos, Administración Pública Municipal y en Alemania el de Sistemas
            Políticos en Europa y América Latina.
          </p>
          <!-- <hr> -->
          <p>Fue diputado federal, director de Educación, Secretario de Desarrollo Municipal de Cuautitlán, Jefe de
            Asesores y Director de Agua Potable, Drenaje y Saneamiento del municipio de Tultitlán y Naucalpan.
          </p>
          <!-- <h2>Blockquotes</h2> -->

          <p>En sus años como empresario consiguió generar empleos directos para más de 500 personas del Estado de
            México y 30 empleos en Estados Unidos.</p>
                  ...
                  <div id="customers-testimonials" class="owl-carousel">
                    ...
                    <div class="item">
                      <div class="shadow-effect">
                        <img class="img-responsive" src="img/paco-santos1.jpg" alt="">
                      </div>
                    </div>
                    ...
                    <div class="item">
                      <div class="shadow-effect">
                        <img class="img-responsive" src="img/paco-santos2.jpg" alt="">
                      </div>
                    </div>
                    ...
                    <div class="item">
                      <div class="shadow-effect">
                        <img class="img-responsive" src="img/paco-santos3.jpg" alt="">
                      </div>
                    </div>
                    ...
                    <div class="item">
                      <div class="shadow-effect">
                        <img class="img-responsive" src="img/paco-santos4.jpg" alt="">
                      </div>
                    </div>
                    <!--TESTIMONIAL 5 -->
                    <div class="item">
