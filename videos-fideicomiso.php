                    ...
                    <div class="card col-lg-4 bg-none border-none border-0 p-3">
                        ...
                        <div class="card-body p-0 mt-3">
                            ...
                            <div class="card bg-none border-none border-0 card-body">
                                    ...
                                    través de un fideicomiso que mostrará total
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body p-0 mt-3">
                            ...
                            <div class="card bg-none border-none border-0 card-body">
                                    ...
                                    <p> Pretendo ser un legislador cercano a la gente, por ello sigo firme en donar el
                                        100
                                        por ciento de mi sueldo como diputado local del #Distrito26, mismo que será
                                        entregado a la Asociación Civil #GUMEN manos unidas, encargada de manejar este
                                        dinero a través de un fideicomiso que mostrará total transparencia.</p>

                                    <p> GUMEN hará la selección de aquellas personas que busquen un apoyo y será el
                                        vinculo
                                        para favorecer a quienes realmente lo necesiten. La asociación se valdrá de
                                        sondeos
                                        para identificar las principales necesidades de la población y así elegir en que
                                        se
                                        ocupará dicho fideicomiso.</p>
                                    <p> Soy un hombre de palabra y seré un legislador cercano a la gente. Soy tu voz en
                                        el
                                        congreso.</p>

                                    <p> Te invito a contestar el sondeo de opinión que realizo GUMEN 👇👇
                                        <a href="https://forms.gle/dLsWo7yjSRwRuYLF8"> <br> Click aquí</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
