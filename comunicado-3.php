    ...
    <div class="row g-5">
      <div class="col-md-12">
        ...
        <div class="col-lg-12 d-flex flex-wrap">
          ...
          <img src="img/img-comunicado3-2.jpeg" alt="">
          ...
          <div class="col-lg-8 col-12 p-4">
            ...
            <div>
              <p>
                En sesión ordinaria Francisco Santos Arreola, diputado por el Dtto. 26 en compañía
                del coordinador de la bancada del PAN Enrique Vargas del Villar, propusieron en
                nombre del grupo parlamentario de Acción Nacional en el Congreso Estatal, la Ley
                que modificará el acuerdo parlamentario en su Art. 61 de la Junta de Coordinación
                Política (JUCOPO) así como en la Mesa Directiva de la LXI Legislatura.
              </p>
            </div>
          </div>
          <hr>
          <div class="col-lg-12 col-12 p-4">
            ...
            <p>
              Esta propuesta establece la rotación en la Presidencia tanto en la Jucopo como en
              mesa directiva por los tres grupos de mayoría, para generar un equilibrio en la
              representación de los partidos. </p>

            <p>Es de señalar que al ser rotativa no podrá el grupo legislativo de un partido tener la
              presidencia de la Jucopo y de la mesa directiva en el mismo periodo que será de un
              año para ambas. El diputado Francisco Santos señala que el poner orden en los
              acuerdos para que se conviertan en leyes es benéfico para la democracia y poniendo
              el ejemplo del refrán: “El buen Juez por su casa empieza”</p>
        ...
        <div class="col-lg-12 d-flex flex-wrap">
          ...
          <div class="card col-12 col-lg-4">
            <div class="card-img">
              <img src="img/img-comunicado3-3.jpeg" alt="">
            </div>
          </div>
          <!-- <div class="card col-12 col-lg-4">
            <div class="card-img">
