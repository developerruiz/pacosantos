...
<body>
  <main class="container rounded-3">
    ...
    <div class="carousel-prueb">
      ...
      <video src="img/arranque_paco.mp4" width="100%" height="auto" muted autoplay loop></video>
    </div>
  ...
  ================================================== -->
    ...
    <div class="container marketing ">
      <div class="col-lg-12 text-center mt-5">
        <h2 class="color-blue display-5"><b>Oficinas</b></h2>
      </div>
      ...
      <div class="">
        <div class="col-lg-12 text-start text-dark text-center">
          <h2 class="color-blue display-5"><b>Quien soy</b></h2>
        </div>
              ...
              <div class="row">
                  <div class="col-lg-12 d-flex flex-wrap py-5">
                      ...
                      <div class="contador ocultar col-12 col-lg-3 my-5 text-center">
                            <div class="contador_cantidad display-5" data-cantidad-total="86637">
                              0
                          </div>
                          <h4>Donaciones</h4>
                      </div>
                      <div class="contador ocultar col-12 col-lg-3 my-5 text-center">
                          <div class="contador_cantidad display-5" data-cantidad-total="13">
                              0
                          </div>
                          <h4>Proyectos</h4>
                      </div>
                      <div class="contador ocultar col-12 col-lg-3 my-5 text-center">
                          <div class="contador_cantidad display-5" data-cantidad-total="8">
                              0
                          </div>
                          <h4>Talleres</h4>
                      </div>
                      <div class="contador ocultar col-12 col-lg-3 my-5 text-center">
                          <div class="contador_cantidad display-5" data-cantidad-total="4">
                              0
                          </div>
                          <h4>Oficinas</h4>
                      </div>
      ...
      <div class="row mb-2">
        ...
        <div class="col-lg-12 text-center">
          <h2 class="color-blue display-5 my-5"><b>Fideicomiso</b></h2>
        </div>
                ...
                <div id="customers-testimonials" class="owl-carousel">
                  ...
                  <!-- <div class="item">
                    <div class="shadow-effect">
                      <img class="img-responsive" src="img/img-gumen-01.JPG" alt="">
                    </div>
                  </div> -->
