      ...
      <div class="col-md-8">
        ...
        <article class="blog-post">
          <h2 class="blog-post-title mb-4">
            OFICINA DE ENLACE CON LA DIPUTACIÓN DEL DISTRITO TOLUCA
          </h2>
          <!-- <i class="fas fa-align-justify"></i> -->
          <article>Av. Miguel Hidalgo Ote S/n Centro, 50000 Toluca de Lerdo, Mex.</article>
          <br>
          <h4>Funcionamiento</h4>
          <!-- <p class="blog-post-meta">January 1, 2021 by <a href="#">Mark</a></p> -->
          <p>
            Encargada de dar soporte a las actividades legislativas del Diputado Franciso Santos,
            también recibirá peticiones ciudadanas y fungirá como un enlace de gestión para los
            programas de las oficinas de Gestión y Atención Ciudadana de Cuautitlán Izcalli,
        ...
        <div class="p-3 mb-4 bg-light rounded-3 border-blue">
        ...
        <div class="row align-items-md-stretch mb-4">
          ...
          <div class="col-md-6">
            <div class="h-100 p-5 bg-light rounded-3 border-rojo">
              <h2>Visión</h2>
              <p>Atender las solicitudes ciudadanas de carácter legislativo de los ciudadanos al Diputado.</p>
            </div>
          </div>
        </div>
