...
<head>
  ...
  <!-- css personalizado -->
  <title>Naturea | Salud en una gota </title>
</head>
            ...
            <form action="registrar.php" method="POST" onsubmit="return validar();" class="formulario-card">
              <div class="form-row my-3 p-4 formulario-card shadow-sm bg-white rounded">
                ...
                <div class="titulo text-start col-lg-12 m-2">
                  <h1>Eventos por oficina</h1>
                  <!-- <h2 class="text-center"><img src="img/logo-naturea.svg" alt="" width="150px"
                ...
                <div class="form-group col-md-12">
                  ...
                  <br>
                  <textarea name="desc-evento" id="" rows=5" placeholder="Descripción del evento" class="form-control"></textarea>
                </div>
                <div class="form-group col-md-12">
                  <label for="inputDate">Fecha de del evento</label>
                ...
                <div class="form-group col-md-12">
                  ...
                  <textarea name="" id="" cols="30" rows="4" class="form-control" placeholder="Ubicación del evento"></textarea>
                </div>
