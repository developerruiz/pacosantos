<?php 
  ...
  $usuario ="SELECT * FROM tb_usuarios WHERE id_usuario = '$id_usuario'";
...
<a href="solicitudes.php" class="mt-5 mb-5 display-6"><i
    class="far fa-arrow-alt-circle-left me-2"></i>Regresar</a>
</div>
