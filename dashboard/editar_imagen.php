...
<body>
        ...
        <div class="row">
            ...
            <div
                ...
                <div class="table-responsive">
                    <div class="">
                        <form action="evento/cambio_imagen.php" method="POST">
                            <br>
                            <table>
                                <tr>
                                    <td>
                            ...
                            <button type="submit" class="btn btn-success btn_archivo">actualizar</button>
                        </form>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Evento:
                                            <?php echo $row['nomEvento']; ?></h5>
    ...
    <script>
        ...
        if (archivo) {
            ...
            console.log('el archivo no esta vacio');
